...
// MODEL INSTANCE UPDATES
    it('instance type using set n save', (done) => { 
        ...
        // Took out below code to make a re-usable function assertName()
            // .then(() => User.find({}))
            // .then((users) => {
            //     assert(users.length === 1);
            //     assert(users[0].name === 'Alex');
...
// MODEL CLASS UPDATES
    ...
    it('A model class can update', (done) => {
        ...
        // first, what you want changed,m then what you want it changed to, then done
        assertName(
...
// UPDATE MANY
// By putting the x for it, xit will make it so mocha will not run this test.
    it('A user can have their postcount incremented by 1', (done) => {
            // Find every user with the name of Joe, and update operator and find the postCount property
            // specify the type of operator you want to use then point it at the properr you want to incrememnnt and how much you want to increment by
